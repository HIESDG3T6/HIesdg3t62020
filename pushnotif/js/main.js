const app = (() => {
  ...
  function displayNotification() {
    if (Notification.permission == 'granted') {
      navigator.serviceWorker.getRegistration().then(reg => {
        ...
        reg.showNotification('hi shannnnn!', options);
      });
    }
  }
  ...
  const applicationServerPublicKey = 'BHMjgLGN8nZiCSksH_wyULGMYCPr5rPdNU7wqr1Ttn8ZdodbnIZHPlF4L3jctp0FLV-WD4ux9-vUyE12qHtqRmI';
